        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse mt-3 mt-lg-0" id="navbarContent">
                ...
                <div class="d-flex align-items-center justify-content-end gap-3 ms-auto">
                    ...
                    <!-- Cart Trigger Button -->
                    <button class="btn btn-primary position-relative d-flex align-items-center gap-2 rounded-pill px-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#cartOffcanvas">
                        <i class="bi bi-cart3 fs-5"></i>
                        <span class="fw-semibold">Keranjang</span>
                        <span id="cartBadge" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger cart-badge">0</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="bg-primary text-white py-4 mb-4 shadow-sm">
        <div class="container text-center text-md-start">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="fw-bold mb-1">Promo Gajian Fest ⚡ Diskon s/d 50%</h2>
                    <p class="mb-0 opacity-75">Dapatkan gratis ongkir ke seluruh Indonesia untuk transaksi min. Rp 150.000!</p>
                </div>
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <a href="#products-section" class="btn btn-light text-primary fw-bold rounded-pill px-4">Belanja Sekarang</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <aside class="col-lg-3">
                <div class="card border-0 shadow-sm rounded-3 p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="fw-bold m-0"><i class="bi bi-funnel me-2"></i>Filter</h5>
                        <button class="btn btn-sm btn-link text-decoration-none p-0" onclick="resetFilters()">Reset</button>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex flex-column gap-2" id="categoryFilter">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="category" id="catAll" value="All" checked onchange="filterProducts()">
                                <label class="form-check-label" for="catAll">Semua Produk</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="category" id="catElektronik" value="Elektronik" onchange="filterProducts()">
                                <label class="form-check-label" for="catElektronik">Elektronik & Gadget</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="category" id="catFashion" value="Fashion" onchange="filterProducts()">
                                <label class="form-check-label" for="catFashion">Fashion & Aksesoris</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="category" id="catLifestyle" value="Lifestyle" onchange="filterProducts()">
                                <label class="form-check-label" for="catLifestyle">Peralatan Rumah</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Price Range Filter -->
                    <div class="mb-4">
                        <label for="priceRange" class="form-label fw-semibold text-secondary small text-uppercase">Maksimal Harga</label>
                        <input type="range" class="form-range" id="priceRange" min="50000" max="15000000" step="500000" value="15000000" oninput="updatePriceLabel(this.value)" onchange="filterProducts()">
                        <div class="d-flex justify-content-between small text-muted">
                            <span>Rp 50rb</span>
                            <span id="priceLabel" class="fw-bold text-primary">Rp 15.000.000</span>
                        </div>
                    </div>

                    <!-- Rating Filter -->
                    <div>
                        <label class="form-label fw-semibold text-secondary small text-uppercase">Rating Min.</label>
                        <select class="form-select form-select-sm" id="ratingFilter" onchange="filterProducts()">
